...
var util = require('/lib/sojourns/util.sjs');
...
QueryBuilder.prototype = {
  ...
  */
   ...
   * @return {Iterator}
   */
  values: delegate(function* (rangeIndexes /* String|String[],  */, ranges, options /* {order: "frequency|item", frequency: "fragment|item", direction: "ascending|descending", limit: N, skip: N, sample: N, truncate: N, score: "logtfidf|logtf|simple|random|zero"}, forests: ["name"], qaulityWeight: N } */) {
